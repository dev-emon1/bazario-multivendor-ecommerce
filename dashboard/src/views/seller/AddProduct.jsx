...
const AddProduct = () => {
  ...
  const removeImage = (index) => {
    ...
    const filteredImgShow = imagesShow.filter((img, i) => i !== index);
    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="bg-white w-full rounded-md p-4">
        <div className="flex justify-between items-center pb-4">
          <h1 className="font-semibold capitalize text-xl">Add Product</h1>
          <Link
              ...
              {imagesShow.map((img, i) => (
                <div className="h-[200px] relative" key={i}>
                  ...
                  <span
                    ...
                    className="p-1 bg-slate-700 text-white hover:bg-slate-500 cursor-pointer rounded-full absolute top-1 right-1"
                  >
